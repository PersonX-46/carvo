...
const Profile: React.FC<ProfileProps> = ({
  ...
  const fetchProfile = async () => {
    try {
      ...
      // Try dedicated profile endpoint first
      ...
      if (!response.ok) {
        ...
        const profileData =
          authResult.customer || authResult.user || authResult;
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-amber-400 font-medium">
                        {getMembershipDuration(profile.joinDate)}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-400 text-sm">Customer ID</p>
                      <p className="text-white font-medium">
                        C{profile.id.toString().padStart(6, "0")}
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <label className="flex items-center space-x-3 cursor-pointer">
                        ...
                        />
                        <span className="text-white">
                          Receive service reminders and maintenance alerts
                        </span>
                      </label>
                    </div>
                  </div>
