...
const ReportsManagement: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const [reportsResponse, analyticsResponse] = await Promise.all([
        ...
        fetch(`/api/admin/analytics?period=${dateRange}`)
      ]);
      ...
      setError('Failed to load reports and analytics. Please try again.');
    } finally {
      setIsLoading(false);
  ...
  const downloadReport = async (reportId: number, downloadUrl?: string) => {
    if (!downloadUrl) {
      setError('No download URL available for this report');
      return;
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={fetchData}
            disabled={isLoading}
            className="px-4 py-2 bg-amber-500/20 text-amber-400 hover:bg-amber-500/30 rounded-lg font-medium transition-colors disabled:opacity-50"
          >
            🔄 Refresh
          </button>
        </div>
      ...
      {activeTab === 'overview' && analyticsData && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard
              title="Total Revenue"
              value={`RM ${analyticsData.financial.totalRevenue.toLocaleString()}`}
            ...
            <StatCard
              title="Net Profit"
              value={`RM ${analyticsData.financial.netProfit.toLocaleString()}`}
              change={8.2}
              icon="📈"
            ...
            <StatCard
              ...
              value={analyticsData.services.completedServices}
              change={5.3}
              icon="✅"
              color="text-blue-400"
            />
            <StatCard
              ...
              value={analyticsData.customers.customerSatisfaction}
              change={2.1}
              icon="⭐"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-800/50 rounded-xl p-5 border border-gray-700">
              ...
              <div className="space-y-3">
                {analyticsData.financial.monthlyRevenue.map((month, index) => (
            ...
            <div className="bg-gray-800/50 rounded-xl p-5 border border-gray-700">
              ...
              <div className="space-y-4">
                {analyticsData.services.popularServices.map((service, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-800/50 rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-white">{analyticsData.customers.newCustomersThisMonth}</p>
              <p className="text-gray-400 text-sm">New Customers This Month</p>
            </div>
            <div className="bg-gray-800/50 rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-white">{analyticsData.services.pendingServices}</p>
              <p className="text-gray-400 text-sm">Pending Services</p>
            </div>
            <div className="bg-gray-800/50 rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-white">{analyticsData.services.averageServiceTime}h</p>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-gray-800/50 rounded-xl p-5 border border-gray-700">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-700">
                  ...
                  <span className="text-green-400 font-semibold">RM {analyticsData.financial.totalRevenue.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-700">
                  <span className="text-gray-400">Total Expenses</span>
                  <span className="text-red-400 font-semibold">RM {analyticsData.financial.totalExpenses.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-700">
                  <span className="text-gray-400">Net Profit</span>
                  <span className="text-emerald-400 font-semibold">RM {analyticsData.financial.netProfit.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <span className="text-gray-400">Revenue Growth</span>
                  <span className="text-green-400 font-semibold">+{analyticsData.financial.revenueGrowth}%</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 rounded-xl p-5 border border-gray-700">
              ...
              <div className="space-y-3">
                {analyticsData.financial.mostProfitableServices.map((service, index) => (
      ...
      {/* Services Tab */}
      {activeTab === 'services' && analyticsData && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-gray-800/50 rounded-xl p-5 border border-gray-700">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-semibold">{analyticsData.services.totalServices}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Completed</span>
                  <span className="text-green-400 font-semibold">{analyticsData.services.completedServices}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Pending</span>
                  <span className="text-orange-400 font-semibold">{analyticsData.services.pendingServices}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Average Service Time</span>
                  <span className="text-blue-400 font-semibold">{analyticsData.services.averageServiceTime} hours</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 rounded-xl p-5 border border-gray-700">
              ...
              <div className="space-y-3">
                {analyticsData.services.workerPerformance.map((worker) => (
      ...
      {/* Customers Tab */}
      {activeTab === 'customers' && analyticsData && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-gray-800/50 rounded-xl p-5 border border-gray-700">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-semibold">{analyticsData.customers.totalCustomers}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">New This Month</span>
                  <span className="text-green-400 font-semibold">{analyticsData.customers.newCustomersThisMonth}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Returning Customers</span>
                  <span className="text-blue-400 font-semibold">{analyticsData.customers.returningCustomers}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Satisfaction Rate</span>
                  <span className="text-yellow-400 font-semibold">{analyticsData.customers.customerSatisfaction}/5</span>
                </div>
              </div>
            </div>
            ...
            <div className="divide-y divide-gray-800">
              {reports.length === 0 ? (
                <div className="p-8 text-center">
                  <p className="text-gray-400">No reports generated yet. Generate your first report above.</p>
                </div>
              ) : (
                reports.map((report) => (
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        {report.downloadUrl && (
                          <button 
                            ...
                            className="bg-amber-500/20 text-amber-400 hover:bg-amber-500/30 px-3 py-1 rounded-lg text-sm transition-colors"
                          >
                            Download
                          </button>
                        )}
